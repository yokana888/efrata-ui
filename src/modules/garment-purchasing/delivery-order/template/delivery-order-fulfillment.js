...
export class DeliveryOrderItem {
  ...
  activate(context) {
    ...
    this.pricePerDealUnit = this.data.pricePerDealUnit.toLocaleString('en-EN', { minimumFractionDigits: 4 }).replace(",","");
    ...
    if (this.data) {
      ...
      if(this.data.pricePerDealUnit){
        this.pricePerDealUnit=this.data.pricePerDealUnit.toLocaleString('en-EN',  { minimumFractionDigits: 4 });}
      if(this.data.dealQuantity){
        this.dealQuantity=this.data.dealQuantity.toLocaleString('en-EN', { minimumFractionDigits: 10 });}
    } else {
