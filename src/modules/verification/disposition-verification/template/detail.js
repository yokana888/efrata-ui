...
export class PurchasingDispositionDetail {
  ...
  activate(context) {
    ...
    this.data.PriceTotal=(parseFloat(this.data.DealQuantity)*parseFloat(this.data.PricePerDealUnit)).toLocaleString('en-EN', { minimumFractionDigits: 2 });
    // if(this.readOnly){
    //   this.data.PaidQuantity=this.data.PaidQuantity.toLocaleString('en-EN', { minimumFractionDigits: 2 });
    //   this.data.PaidPrice=this.data.PaidPrice.toLocaleString('en-EN', { minimumFractionDigits: 2 });
    //   this.data.TotalPaidPrice=this.data.TotalPaidPrice.toLocaleString('en-EN', { minimumFractionDigits: 2 });
    // }
