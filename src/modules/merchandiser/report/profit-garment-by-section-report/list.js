                  ...
                  for (var data of result) {
                       var SECTION = data.Section;
                        if (!dataBySection[SECTION]) dataBySection[SECTION] = [];                 
                            ...
                            CMPrice : data.CMPrice.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 4}),
                            FOBPrice : data.FOBPrice.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 4}),
